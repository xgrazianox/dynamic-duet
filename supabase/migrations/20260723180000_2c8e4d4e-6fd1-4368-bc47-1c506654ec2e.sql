...
-- (come le RPC di regime dopo l'hotfix F5).
-- DECISIONE ARGOMENTATA: le RPC contabili F1 (register_operation,
-- register_reversal, import_opening_balances, amend_opening_import) NON sono
-- riscritte: l'ordine idem→lock non è deadlock-abile (mutation_requests è
-- scopata per rpc_name) e riscrivere il percorso del denaro, collaudato dai
-- casi golden, per una modifica cosmetica viola il principio di rischio minimo.
-- INVARIATI: firma, payload, semantica, grant, risultati.
-- =========================================================================
