...
DECLARE
  ...
  v_op_type public.op_type; v_eff date; v_instr uuid; v_qty numeric;
  v_price numeric; v_ccy public.currency_code; v_fx numeric; v_gross numeric;
  v_fees numeric; v_notes text; v_track date; v_op_id uuid;
  v_inst_ccy public.currency_code; v_inst_status public.instrument_status;
BEGIN
  ...
  VALUES (v_pid, v_op_type, v_instr, v_qty, v_price, v_ccy,
    v_fx, v_gross, v_fees, v_eff, v_notes, _key, v_hash)
...
DECLARE
  v_pid uuid; v_hash text; v_mreq_id uuid; v_cached jsonb;
  v_op_id uuid; v_notes text; v_orig public.operations%ROWTYPE;
  v_rev_id uuid; v_canonical jsonb;
BEGIN
  v_pid := public._owned_portfolio();
